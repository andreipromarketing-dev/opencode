...
**That's it!** You now have access to 47 agents, 181 skills, and 82 legacy command shims.
...
| Commands | PASS: 82 commands | PASS: 31 commands | **Claude Code leads** |
...
| **Commands** | 82 | Shared | Instruction-based | 31 |
